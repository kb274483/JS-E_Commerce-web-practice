...
function definition(){
    ...
    prevItem.addEventListener('click',prevItemNumber);
...
function nextItemNumber(){
  let itemNumber = parseInt(localStorage.getItem('itemNum'));
  itemNumber = itemNumber + 1;
  if(itemNumber > 12){
    itemNumber = 1 ;
    localStorage.setItem('itemNum',itemNumber);
  }else{
    localStorage.setItem('itemNum',itemNumber);
  }
  renderScreen();
...
function renderScreen(){
  let itemNumber = parseInt(localStorage.getItem('itemNum'));
  itemNumber = itemNumber - 1; 
  let renderTheScreen = document.querySelector('.productContainer');
  renderTheScreen.innerHTML = `
  <div class="productImg">
    <img src="${list[itemNumber].img}" alt="productImg">
    <div class="line"></div>
    <p>I'm a product description. 
      I’m a great place to include more information about your product.
      Buyers like to know what they’re getting before they purchase.
    </p>
  </div>
  
  <div class="produtInfo">
    <h2 class="productName">${list[itemNumber].name}</h2>
    <div class="itemNumber">ItemNum:${list[itemNumber].itemNum}</div>
    <div class="productPrice"> NTD: ${list[itemNumber].price}</div>
    <h5 class="productQuantity">Quantity</h5>
      <input type="number" value="1" class="quantity">
    <div class="cartbtn">
      <a href="#" data-add="add" data-itemcon="${list[itemNumber].itemNum}">Add Cart</a>
  </div>
  ...
  <div class="information">
      <h3>PRODUCT INFO</h3>
      <p>
        I'm a product detail. I'm a great place 
        to add more information about your product 
        such as sizing, material, care and cleaning 
        ...
        Buyers like to know what they’re getting 
  ...
  <div class="refund">
    ...
    <p>
        ...
        I’m a great place to let your customers know 
        what to do in case they are dissatisfied 
        with their purchase. Having a straightforward 
