...
function definition() {
    ...
    let inputBGColor = document.getElementsByClassName('inputInfo');
...
function changeBGColor(e) {
    e.target.style.backgroundColor = '#fddcab';
}
...
function amount() {
    ...
    summaryPrice.innerHTML = `NTD ${subtotal}`;
